...
W czasach w których wytwarzane są niespotykane do tej pory ilości danych (w latach 2017-2018 powstało 90\% danych które kiedykolwiek powstały [1] https://www.forbes.com/sites/bernardmarr/2018/05/21/how-much-data-do-we-create-every-day-the-mind-blowing-stats-everyone-should-read/#65af925260ba
i nie ma przesłanek stanowiących o tym, że tempo wzrostu opadnie, w których prędkości przetwarzania komputerów nie rosną współmiernie, potrzebne są rozwiązania algorytmiczne które umożliwią ich analizę.

W tej pracy zaproponowano rozwiązania mogące przyspieszyć bardzo powszechne operacjach na danych w postaci tabel.

Przykładem takich danych są table w programie Microsoft Excel i jemu podobnych, pliki typu Comma Separated Values (CSV), tabele i widoki w relacyjnych bazach danych czy struktury tworzne przez biblioteki do manipulowania i analizy danych jak Pandas.

Przykładów danych które można reprezentować w ten sposób są między innymi dane pogodowe, wyniki giełdy, opisy przypadków osób z chorobami serca czy log połączeń do danego serwera.

\section{Oznaczenia przyjęte w pracy}

Hasła "tabla", "tablica", "macierz" stosowane będą zamiennie i będą oznaczały strukturę danych składającą się z listy krotek. 

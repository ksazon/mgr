...
Stosunki czasów $C_{max}$ (heurystyka do naiwnego) w zależności od ilości zadanych komórek znajdują się na wykresie diagnostycznym \ref{diag:time_ratio_2}.

\begin{figure}[!tbh]
\centering
\includegraphics[width=.8\hsize]{fig/time_ratio_2.png}

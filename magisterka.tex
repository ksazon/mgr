...
W obecnych czasach wytwarzane są niespotykane do tej pory ilości danych (w latach 2017-2018 powstało 90\% danych które kiedykolwiek powstały [1] https://www.forbes.com/sites/bernardmarr/2018/05/21/how-much-data-do-we-create-every-day-the-mind-blowing-stats-everyone-should-read/#65af925260ba
i nie istnieją żadne przesłanki stanowiące o tym, że tempo wzrostu opadnie. Jednocześnie prędkości przetwarzania komputerów nie rosną współmiernie. Pozostawia to deficyt technologiczny do pokrycia którego potrzebne są rozwiązania związane z oprogramowaniem, w szczególności algorytmiczne.

W pracy zaproponowano rozwiązania mogące przyspieszyć bardzo powszechne operacjach na danych w postaci tabel.

Przykładem takich danych są table w programie \emph{Microsoft Excel} i jemu podobnych, pliki z wartościami rodzielanymi przecinkiem (Comma Separated Values - \emph{CSV}), tabele i widoki w relacyjnych bazach danych, pliki \emph{Parquet} czy struktury tworzne przez biblioteki do manipulowania i analizy danych jak \emph{pandas}.

Przykładami danych które można reprezentować w ten sposób są między innymi dane pogodowe, wyniki giełdy, opisy przypadków osób z chorobami serca czy dziennik połączeń do danego serwera.
